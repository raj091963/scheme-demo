...
__d("PluginMessage", ["Arbiter", "CSS", "DOM", "DOMEventListener"], (function(a, b, c, d, e, f, g) {
    ...
    function a() {
        d("DOMEventListener").add(window, "message", function(a) {
            if (/\.facebook\.com$/.test(a.origin))
                ...
                } else if (i().test(a.data)) {
                b = JSON.parse(a.data.substring(24));
                "type" in b && (b.type === "send_to_messenger" ? j(b) : b.type === "messenger_checkbox" ? k(b) : b.type === "customer_chat" && m(b))
            }
        })
    }
    ...
    function j(a) {
        var b = document.getElementById("send-to-messenger-connect-button"),
            c = document.getElementById("send-to-messenger-disconnect-button"),
            e = document.getElementById("send-to-messenger-identity"),
            f = document.getElementById("send-to-messenger-profile-photo"),
            g = document.getElementById("send-to-messenger-profile-name");
        b != null && c != null && e != null && f != null && g != null && (a.can_personalize === !0 && a.connected === !0 ? (d("CSS").show(b), d("CSS").hide(c), l(f, a.profile_photo), l(g, a.profile_name), d("CSS").show(e)) : (d("CSS").hide(b), d("CSS").show(c), d("CSS").hide(e)))
    }
...
__d("RunBlue", ["Arbiter", "BigPipeInstance", "ContextualComponent", "ExecutionEnvironment", "PageEvents", "TimeSlice", "createCancelableFunction", "emptyFunction", "isTruthy", "performanceAbsoluteNow", "recoverableViolation"], (function(a, b, c, d, e, f, g) {
    ...
    c("ExecutionEnvironment").canUseDOM && s();
